        ...
        <div className="about">
            ...
            <section className="contact">
                ...
                <div className="contact-links">
                    <a href="mailto:narla.a@northeastern.edu" className="contact-link">
                        📧 narla.a@northeastern.edu
                    </a>
                    <a href="tel:+18574249599" className="contact-link">
                        📱 (857) 424-9599
                    </a>
                    <a href="https://linkedin.com/in/aditya-narla" target="_blank" rel="noopener noreferrer" className="contact-link">
                        💼 LinkedIn
                    </a>
                    <a href="https://github.com/aditya-narla" target="_blank" rel="noopener noreferrer" className="contact-link">
                        💻 GitHub
                    </a>
                </div>
            </section>
